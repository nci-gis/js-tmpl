...
The very beginning analysis phase of js-tmpl is documented in `docs/analysis/`:

- [`docs/analysis/overview.md`](../docs/analysis/overview.md) — Project overview and architectural analysis
- [`docs/analysis/initial-phase.md`](../docs/analysis/initial-phase.md) — PDCA-based implementation roadmap (v0.0.1 → v1.0.0)

These documents capture the **initial project vision**, design decisions, and development
strategy established before implementation began. They serve as historical context for
understanding the project's origins and intended direction.
