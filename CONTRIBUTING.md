...
# Specific version
npm install @nci-gis/js-tmpl@1.2.3-beta.1
```
...
- [ ] Verify package appears on <https://www.npmjs.com/package/@nci-gis/js-tmpl>
- [ ] Test installation: `npm install @nci-gis/js-tmpl@latest`
