...
export const ErrorCodes = Object.freeze({
  ...
  CONFIG_UNKNOWN_KEY: 'JSTMPL_CONFIG_UNKNOWN_KEY',
  ...
  TEMPLATE_DIR_LOOP: 'JSTMPL_TEMPLATE_DIR_LOOP',
  // Output
  OUTPUT_OUTSIDE_OUTDIR: 'JSTMPL_OUTPUT_OUTSIDE_OUTDIR',
  OUTPUT_COLLISION: 'JSTMPL_OUTPUT_COLLISION',
  OUTPUT_BLOCKED: 'JSTMPL_OUTPUT_BLOCKED',
  OUTPUT_LINKED: 'JSTMPL_OUTPUT_LINKED',
  // registerHelpers
